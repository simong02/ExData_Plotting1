...
#set up plotting screen to contain 2X2 matrix of plots
par(mfrow=c(2,2))
#Plot1
...
#Plot3
plot(data$t, data$Voltage,xlab="datetime", ylab="Voltage", type="l")
#Plot4
plot(data$t, data$Global_reactive_power,xlab="datetime", ylab="Global_reactive_power", type="l")
dev.off()
